...
<template>
            ...
            <div class="lg:block hidden lg:w-4/12 h-screen border-l border-gray-800 pl-4">
                ...
                <div class="w-full mt-4 rounded-lg lg:block hidden bg-[#212327]">
                    ...
                    <div class="h-[80px] hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 jusfify-between h-[80px] py-3">
                            <div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 jusfify-between">
                            <div>
                                ...
                                <div class="text-[14px] text-gray-400">5999 Tweets</div>
                            </div>
                          <DotsHorizontal class="ml-12" fillColor="#5e5c5c"/>
                        </div>
                    </div>
                    <!---->
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 jusfify-between">
                            <div>
                                ...
                                <div class="text-[14px] text-gray-400">100,000 Tweets</div>
                            </div>
                          <DotsHorizontal class="ml-12" fillColor="#5e5c5c"/>
                        </div>
                    </div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 jusfify-between">
                            <div>
                                ...
                                <div class="text-[14px] text-gray-400">120,000 Tweets</div>
                            </div>
                            <DotsHorizontal class="ml-12" fillColor="#5e5c5c"/>
                        </div>
                    </div>
    ...
    <div id="OverlaySection" v-if="createTweet" class="fixed top-0 left-0 w-full h-screen bg-black md:bg-gray-400 md:bg-opacity-30 mb-5">
        <div class="md:max-w-2xl md:mx-auto md:mt-10 md:rounded-xl bg-black">
            ...
            <div class="w-full flex">
                ...
                <div class="w-[calc(100%-100px)]">
                    ...
                    <div class="flex items-cener justify-between py-2">
